        ...
        <VStack spacing={8}>
          ...
          <HStack spacing={8} wrap="wrap" justify="center">
            <Box maxW="sm" p={4} boxShadow="md" borderRadius="lg">
              <Image src="https://images.unsplash.com/photo-1499951360447-b19be8fe80f5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjB3ZWJzaXRlJTIwZGVzaWdufGVufDB8fHx8MTcxMjM5MDk2OXww&ixlib=rb-4.0.3&q=80&w=1080" />
            ...
            <Box maxW="sm" p={4} boxShadow="md" borderRadius="lg">
              <Image src="https://images.unsplash.com/photo-1477013743164-ffc3a5e556da?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxzZW8lMjBhbmQlMjBhbmFseXRpY3N8ZW58MHx8fHwxNzEyMzkwOTcwfDA&ixlib=rb-4.0.3&q=80&w=1080" />
              <Heading as="h4" size="md" mt={4}>
                SEO & Analytics
              </Heading>
            ...
            <Box maxW="sm" p={4} boxShadow="md" borderRadius="lg">
              <Image src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxzZWN1cmUlMjB3ZWJzaXRlfGVufDB8fHx8MTcxMjM5MDk3MXww&ixlib=rb-4.0.3&q=80&w=1080" />
              <Heading as="h4" size="md" mt={4}>
                Security
              </Heading>
